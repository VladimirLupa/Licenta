        ...
        if (empty($_POST['email_input'])) 
        ...
        else
            {
                ...
                if(verifyEmail($email) == "true")
                {
                    ...
                    if ($query)
                    {
                        $link = '192.168.15.47/interfata_login/v1.0/pagini/forgpass.php?email='.$email.'&token='.$token;
                        $headers  = 'MIME-Version: 1.0' . "\r\n";
                        $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                        $message = "
                        <div style = 'width:60%;'><br><br>
                        ...
                        <div>
                            <a href='$link' target='_blank'>
                                <input style='width:30%;
                                            ...
                                            color:white;
                                            cursor:pointer;' name='submit' type='submit' value='Reseteaza parola'></a><br><br>
                            Daca nu ati cerut resetarea parolei, va rugam ignorati acest mail. Linkul pentru resetarea parolei este valabil pentru urmatoarele 3 ore.<br><br>
                            <hr>
                            <div>
                            Daca nu puteti accesa butonul, copiati linkul de mai jos in browserul dumneavoastra.<br>
                            <a href='$link' target='_blank'>192.168.15.47/interfata_login/v1.0/pagini/forgpass.php?email=$email&token=$token</a></div><br><br>
                            Va multumim,<br>
	                                Adminul siteului
                        </div>
                      ";
