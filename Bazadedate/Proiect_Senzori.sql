...
CREATE TABLE `Senzori` (
  `IdSenzor` bigint(20) NOT NULL AUTO_INCREMENT,
  `TipSenzor` varchar(45) NOT NULL,
  `ModelSenzor` varchar(45) NOT NULL,
...
LOCK TABLES `Senzori` WRITE;
/*!40000 ALTER TABLE `Senzori` DISABLE KEYS */;
/*!40000 ALTER TABLE `Senzori` ENABLE KEYS */;
UNLOCK TABLES;
